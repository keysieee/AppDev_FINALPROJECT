...
exports.signup = async (req, res) => {
    ...
    try {
        ...
        await con.promise().query('INSERT INTO employee (id_no, name, password) VALUES (?, ?, ?)', [id_no, name, hashedPassword]);
        res.redirect('/login');
    } catch (err) {
...
exports.login = async (req, res) => {
    ...
    try {
        const [rows] = await con.promise().query('SELECT * FROM employee WHERE id_no = ?', [id_no]);
